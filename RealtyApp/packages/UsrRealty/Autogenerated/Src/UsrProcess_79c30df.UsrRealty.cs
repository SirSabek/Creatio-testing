namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrProcess_79c30dfMethodsWrapper

	/// <exclude/>
	public class UsrProcess_79c30dfMethodsWrapper : ProcessModel
	{

		public UsrProcess_79c30dfMethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			Guid realtyId = Get<Guid>("RealtyId");
